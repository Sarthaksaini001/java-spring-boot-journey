...
public class PayrollDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Employee ID: " + newHire1.getId());
        System.out.println("Employee Name: " + newHire1.getName());
        System.out.println("Department: " + newHire1.getDepartment());
        System.out.println("Base Salary: $" + String.format("%.2f", newHire1.getBaseSalary()));
        ...
        newHire1.setDepartment("Engineering");
        ...
        newHire2.setBaseSalary(62000.0);
        ...
        existing1.incrementYearsOfService();
